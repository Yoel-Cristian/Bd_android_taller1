...
class EliminarAdministrador : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actualizar.setOnClickListener {
            ...
            val intent = Intent(this, ActualizarAdministrador::class.java)
            startActivity(intent)
        }
    }
    ...
    private fun CargarNombreRegistroCliente() {
        ...
        var url = "http://$ip1/demil/Administrador/listar_Registro.php" // servicio web cambiarddddddd
    ...
    fun EliminarDatos(idRegistro: String){
        ...
        val url = "http://$ip1/demil/Administrador/eliminar_Registro.php"
        val requestQueue = Volley.newRequestQueue(this)
