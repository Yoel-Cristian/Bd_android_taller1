...
class InsertarProducto : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var etDescripcion: EditText = findViewById(R.id.etDescripcion)
        var etPrecio: EditText = findViewById(R.id.etPrecio)
        var etStock: EditText = findViewById(R.id.etStock)
        ...
        btnEnviar.setOnClickListener {
            ...
            insertarDatos(nombre, descripcion, precio, stock, categoriaID)
    ...
    private fun insertarDatos(
        ...
        var ip1= Ip.ip
        val url = "http://$ip1/demil/insertar_producto.php"  // Reemplaza con la URL de tu script PHP
